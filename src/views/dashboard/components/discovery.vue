<template>
  <div v-if="data" class="disPlay-card">
    <DataCard
      ...
      day="12000"
      chain="10%"
      :icon="require('/@/assets/image/home/turnover.png')"
      background="#ff7c9f"
    ...
    <DataCard
      ...
      day="18000"
      chain="15%"
      :icon="require('/@/assets/image/home/consume-bi.png')"
      background="#C391FF"
    ...
    <DataCard
      ...
      day="52000"
      chain="5%"
      :icon="require('/@/assets/image/home/gift-integral.png')"
      background="#66CEA1"
          ...
          <div class="line">
            <div class="label">
              ...
              <el-tooltip
                ...
                placement="top-start"
              >
                <img src="/@/assets/image/home/help.png" class="icon" />
              </el-tooltip>
            </div>
    ...
    <div class="card-section tools">
      ...
      <div class="wrap">
        <Tools
          ...
          :icon="require('/@/assets/image/home/t-1.png')"
        />
        <Tools
          class="item"
          title="订单明细"
          link="/#/business/order-detail"
          :icon="require('/@/assets/image/home/t-2.png')"
        />
        <Tools
          class="item"
          title="会员档案"
          link="/#/member/member-archives"
          :icon="require('/@/assets/image/home/t-3.png')"
        />
        <!-- <Tools class="item" title="库存管理" :icon="require('/@/assets/image/home/t-4.png')" />
					<Tools class="item" title="实物币进出记录" :icon="require('/@/assets/image/home/t-5.png')" />
					<Tools class="item" title="抄码表记录" :icon="require('/@/assets/image/home/t-6.png')" /> -->
      </div>
    </div>
  </div>
</template>
