    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column
          ...
          sortable="custom"
        ></el-table-column>
        <!-- <el-table-column min-width="180" label="回收方式"></el-table-column> -->
        <el-table-column
          label="回收数量"
          prop="qty"
          min-width="120"
      ...
      >
        ...
        <el-table-column label="回收彩票数" min-width="120">
          <template #default>0</template>
        </el-table-column>
        <el-table-column label="回收积分数" min-width="120">
          <template #default>0</template>
        </el-table-column>
        <el-table-column
          label="回收礼品积分数"
        ...
        <el-table-column label="回收代币数" min-width="120"
          ><template #default>0</template></el-table-column
        >
        <el-table-column label="回收特殊彩票数" min-width="120"
          ><template #default>0</template></el-table-column
        >
        <el-table-column
          label="门店"
...
import RecoveryOrderDetail from "./recovery-order-detail.vue";
