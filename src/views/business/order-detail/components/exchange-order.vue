  ...
  <div>
    ...
    <div class="table">
      ...
      >
        ...
        <!-- <el-table-column label="兑换渠道" min-width="180"></el-table-column> -->
        <el-table-column
          label="操作终端"
          min-width="180"
          prop="device_name_no"
      ...
      >
        ...
        <el-table-column
          ...
          prop="cost"
        ></el-table-column>
        <el-table-column label="彩票兑换数" min-width="120"></el-table-column>
        <el-table-column label="积分兑换数" min-width="120"></el-table-column>
        <el-table-column
          label="礼品积分兑换数"
          min-width="120"
          prop="px_paid"
        ...
        <el-table-column label="代币兑换数" min-width="120"></el-table-column>
        <el-table-column
          label="门店"
          min-width="170"
          prop="store_name_no"
...
const doSearch = async (key = "modify_time", type = 0) => {
  ...
  //       order_type: 2, // 定死为兑换订单
  //       sort_field_name: key ? key : '',
  //       sort_type: type,
  //       leager_id: id,
  //     }
  //   )
